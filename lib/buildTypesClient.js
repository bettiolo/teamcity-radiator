...
module.exports.sortBuildTypesByLatestBuild = function (buildTypes, callback) {
    "use strict";
    var sortedBuildTypes = _(buildTypes)
        .sortBy(function (buildType) {
            return buildType.latestBuild.id;
        })
        .reverse()
        .value();
